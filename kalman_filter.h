...
class KalmanFilter {
  ...
  KalmanFilter(const Eigen::Matrix<scalar, StateLength, StateLength>& A,
               ...
               const Eigen::Matrix<scalar, MeasSignalLength, MeasSignalLength>& R) : A_{A}, B_{B}, Q_{Q}, C_{C}, R_{R}{
  }
  ...
  void Init(const Eigen::Matrix<scalar, StateLength, 1>& mu, const Eigen::Matrix<scalar, StateLength, StateLength>& P) {
    mu_ = mu;
    P_ = P;
    is_initialized = true;
  }
  ...
  const Eigen::Matrix<scalar, StateLength, StateLength> A_{Eigen::Matrix<scalar, StateLength, StateLength>::Identity()};
  const Eigen::Matrix<scalar, StateLength, ProcSignalLength> B_{Eigen::Matrix<scalar, StateLength, StateLength>::Identity()};
  const Eigen::Matrix<scalar, ProcSignalLength, ProcSignalLength> Q_{Eigen::Matrix<scalar, StateLength, StateLength>::Identity()};
  const Eigen::Matrix<scalar, MeasSignalLength, StateLength> C_{Eigen::Matrix<scalar, StateLength, StateLength>::Identity()};
  const Eigen::Matrix<scalar, MeasSignalLength, MeasSignalLength> R_{Eigen::Matrix<scalar, StateLength, StateLength>::Identity()};
  const Eigen::Matrix<scalar, StateLength, StateLength> I_{Eigen::Matrix<scalar, StateLength, StateLength>::Identity()};
  Eigen::Matrix<scalar, StateLength, 1> mu_{Eigen::Matrix<scalar, StateLength, 1>::Zero()};
  Eigen::Matrix<scalar, StateLength, StateLength> P_{Eigen::Matrix<scalar, StateLength, StateLength>::Identity()};
